            ...
            <div className="row mt-5 pt-3">
                ...
                <div className="col-lg-7 col-md-6 col-12 py-4 px-md-4 px-lg-5 px-3">
                    ...
                    <ul className="pt-3 list-unstyled">
                        ...
                        <li className="fontSizeChange py-2"> <span className="infoProperty"><b>Experience</b></span> <b className="me-2">: </b> 2 years </li>
                        <li className="fontSizeChange py-2"> <span className="infoProperty"><b>Phone</b></span> <b className="me-2">: </b> +923244679807 </li>
                        <li className="fontSizeChange py-2"> <span className="infoProperty"><b>Email</b></span> <b className="me-2">: </b> iamsafdarawan@gmail.com </li>
